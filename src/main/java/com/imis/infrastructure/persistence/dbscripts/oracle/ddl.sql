...
DROP SEQUENCE "SEQ_EMPLOYER";
DROP SEQUENCE "SEQ_ORGANIZATION";
DROP SEQUENCE "SEQ_POSITION";
DROP SEQUENCE "SEQ_POSITION_GROUP";
...
--------------------------------------------------------
   ...
   CREATE SEQUENCE  "SEQ_AUTHORITIES"  MINVALUE 1 MAXVALUE 9999999999999999999999999999 INCREMENT BY 1 START WITH 21 CACHE 10 NOORDER  NOCYCLE  NOPARTITION ;
--------------------------------------------------------
--  DDL for Sequence SEQ_EDUCATION
--------------------------------------------------------

   CREATE SEQUENCE  "SEQ_EDUCATION"  MINVALUE 1 MAXVALUE 9999999999999999999999999999 INCREMENT BY 1 START WITH 11 CACHE 10 NOORDER  NOCYCLE  NOPARTITION ;
--------------------------------------------------------
...
--------------------------------------------------------
   ...
   CREATE SEQUENCE  "SEQ_STUDENT"  MINVALUE 1 MAXVALUE 9999999999999999999999999999 INCREMENT BY 1 START WITH 31 CACHE 10 NOORDER  NOCYCLE  NOPARTITION ;
--------------------------------------------------------
--  DDL for Sequence SEQ_USERS
--------------------------------------------------------

   CREATE SEQUENCE  "SEQ_USERS"  MINVALUE 1 MAXVALUE 9999999999999999999999999999 INCREMENT BY 1 START WITH 31 CACHE 10 NOORDER  NOCYCLE  NOPARTITION ;
--------------------------------------------------------
--  DDL for Sequence SEQ_WORK
--------------------------------------------------------

   CREATE SEQUENCE  "SEQ_WORK"  MINVALUE 1 MAXVALUE 9999999999999999999999999999 INCREMENT BY 1 START WITH 51 CACHE 10 NOORDER  NOCYCLE  NOPARTITION ;
--------------------------------------------------------

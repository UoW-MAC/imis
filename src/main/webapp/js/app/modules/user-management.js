...
define(['jquery', 'bootstrap', 'handlebars', 'imis', 'validate', 'ajaxHandler', 'formValidator',
        'additionalMethods', 'pagination', 'selector', 'jqueryForm', 'eventHandler', 'questionnaire'],
        function($, bootstrap, handlebars, imis, validate, ajaxHandler, formValidator,
                 additionalMethods, pagination, selector, jqueryForm, eventHandler, questionnaire) {
                ...
                exportCSV: function() {
                    ...
                    $.ajax({
                        ...
                        success : function(data) {
                            ...
                            location.href = "/imis/downloadCsv?csvFileName=" + data.returnValue;
                        }
                    });
                },
                q1: function(){
            ...
            imis.UserManagement = userManagement;

...
define(['jquery', 'bootstrap', 'imis', 'validate', 'ajaxHandler', 'formValidator', 'additionalMethods'],
    function($, bootstrap, imis, validate, ajaxHandler, formValidator, additionalMethods) {

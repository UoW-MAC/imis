 ...
 */
define(['jquery', 'bootstrap', 'imis', 'validate',  'formValidator', 'additionalMethods', 'questionnaire', 'jqueryForm', 'eventHandler'],
        function($, bootstrap, imis, validate, formValidator, additionalMethods, questionnaire, jqueryForm, eventHandler) {
            ...
            imis.UserApplicationForm = userApplicationForm;
